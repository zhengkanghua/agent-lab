...
from news_vector_service.pipeline.ollama_embedding_provider import OllamaEmbeddingError
from news_vector_service.qdrant.search import QdrantVectorSearchError
