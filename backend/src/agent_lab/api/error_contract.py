...
PROCESSING_ERROR_DETAILS = {
    ...
    "document_deletion_conflict": (409, "删除目标已变化，请核对待办后继续。", False),
    "document_delete_failed": (503, "删除尚未完成，原件与历史的清理进度已保留，请刷新后继续删除。", True),
    "document_not_uploaded": (409, "此操作仅适用于上传文档。", False),
